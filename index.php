...
<body>
 ...
 -->
              ...
              <div class="row">
                ...
                if ($cat !== null) {
                  $Productos = Producto::findCategoria($cnx, $cat);
                } elseif ($search !== null) {
                  $Productos = Producto::getSearch($cnx, $search);
                } else {
                  $Productos = Producto::getProductosRandom($cnx);
                }
                ...
                <!-- PRODUCT-->
                <form method="post" action="index.php" href="index.php?search=<?php $search ?>">
